                    ...
                    <div class="sidebar-container">
                        ...
                        <nav class="menu">
                            ...
                            <li class="active">
                                ...
                                <li >
                                    <a href="AfficherDiagnostique.php">
                                        <i class="fa fa-home"></i> Diagnostique </a>
                                </li>
                                <li >
                                    <a href="AfficherCategories.php">
                                        <i class="fa fa-home"></i> Categorie </a>
                                </li>
                                <li >
                                    <a href="AfficherProduits.php">
                                        <i class="fa fa-home"></i> Produit </a>
                                </li>
